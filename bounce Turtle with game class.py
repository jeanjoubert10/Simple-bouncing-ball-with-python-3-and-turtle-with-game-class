# Simple bounce/paddle game in python 3 and turtle
# J Joubert October 2019
# Written in osX and IDLE
# May need slight adjustment for speed in Windows (see below)
...
class Ball(turtle.Turtle):
    def __init__(self, paddle):
        ...
        self.color('red')
        self.dx, self.dy = 6, 4 #  May need adjustment in windows eg 0.05?
        self.up()
        self.paddle = paddle
